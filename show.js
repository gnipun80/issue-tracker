...
function Reopened(i) {
  ...
  localStorage.setItem('issues', JSON.stringify(issues));
 alert("The Issue is now Reopened.");
  window.location.reload();
}
...
function closedissues()
{
  ...
  if(issues.length!=0) 
    {
      document.getElementById('issuesList').innerHTML+='<div class="well">'+'<h1> Closed Issues : </h1>'
    }
  var conf=0;
 ...
 +'<br></br>'+'<p><span class="glyphicon glyphicon-tag"></span>'+' '+'Tag : '+'<span class="label label-info">'+tagline+'</p>';
      }
}
}
...
function openissues()
{
  ...
  if(issues.length!=0) 
    {
      document.getElementById('issuesList').innerHTML+='<div class="well">'+'<h1> Open Issues : </h1>'
    }
   for(i=0;i<issues.length;i++)
  {
    var id=issues[i].id;
 ...
 +'<br></br>'+'<p><span class="glyphicon glyphicon-tag"></span>'+' '+'Tag : '+'<span class="label label-info">'+ tagline +'</span></h4></p>';
      }
}
}
function fetchIssues () {
  ...
  if(issues.length!=0) 
    {
      document.getElementById('issuesList').innerHTML+='<div class="well">'+'<h1> Issues : </h1>'
    }
  for(i=0;i<issues.length;i++)
  {
    var id=issues[i].id;
